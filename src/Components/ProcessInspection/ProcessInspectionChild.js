...
import ProcessInspectImage from "./ProcessInspectImage";
import { NpdDocDownload } from "../../ApiService/DownloadCsvReportsService";

const label = { inputProps: { "aria-label": "Checkbox demo" } };

const ProcessInspectionChild = ({
  ...
  setFileTypeForView, pdfOpen, setPdfOpen,scrollToRow,selectedRowId
}) => {
...
export default ProcessInspectionChild;
