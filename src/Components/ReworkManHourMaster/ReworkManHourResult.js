...
import { COPQDelete, COPQShowData, MaterialRateDelete, MaterialRateShowData, QualityInsMstDelete, ReworkManHourDelete, ReworkManHourShowData } from '../../ApiService/LoginPageService';
import ApplicationStore from '../../Utility/localStorageUtil';
import ReworkManHourModule from './ReworkManHourModule';
import ReworkManHourTitle from './ReworkManHourTitle';
import { useModuleLocks } from '../context/ModuleLockContext';

const ReworkManHourResult = () => {
    const moduleLocks = useModuleLocks();
    const isModuleLocked =
        moduleLocks.find(m => m.moduleName === "COPQ")?.lockStatus === "locked";
    const [rows, setRows] = useState([]);
    const [isAddButton, setIsAddButton] = useState(true);
    const [editManHourRate, setEditManhourRate] = useState([]);
                ...
                <EditIcon
                    ...
                    onClick={(event) => {
                        if (userPermission[0]?.updateData === 1 && !isModuleLocked) {
                            ...
                            setEditManhourRate(props.selectedRow);
                            setOpen(true);
                        }
                    }}
                />
    ...
    return (
        <div style={{ height: '60vh', width: '100%' }}>
            <ReworkManHourTitle
                ...
                setEditManhourRate={setEditManhourRate}
                setOpen={setOpen}
            />
            ...
            <ReworkManHourModule
                ...
                editManHourRate={editManHourRate}
                open={open}
                setOpen={setOpen}
            ...
            <DeleteConfirmationDailog
                ...
                deleteId={deleteId}
                deleteService={ReworkManHourDelete}
...
export default ReworkManHourResult
