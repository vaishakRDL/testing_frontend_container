import {
    Button, Box, Dialog, Tooltip, DialogContent, CircularProgress, DialogTitle, TextField, Grid, DialogActions, InputLabel, Select, MenuItem, FormControl, FormControlLabel, Checkbox, CardContent, Typography, InputAdornment, Card, Autocomplete,
} from '@mui/material';
...
const NpdModule = ({ open, setOpen, isAddButton, editData, setRefreshData, isDrawing }) => {
