...
import { OperatorList, OperatorToolReport, ProcessToolMachineList } from "../../../ApiService/LoginPageService";
import ExcelJS from 'exceljs';
import { saveAs } from 'file-saver';
const ToolBrokenVsPartNoVsOperatorReport = () => {
  ...
  useEffect(() => {
    ...
    OperatorList(handleOperatorSuccess,handleOperatorException)
  }, []);
...
const handleOperatorSuccess=(dataObject)=>{
    setOperatorList(dataObject?.data || []);
}

const handleOperatorException=()=>{
          ...
          <FormControl fullWidth>
            ...
            >
              {operatorList.map((data) => (
                <MenuItem key={data.id} value={data.operator}>
                  {data.operator}
                </MenuItem>
              ))}
            </Select>
...
export default ToolBrokenVsPartNoVsOperatorReport;
