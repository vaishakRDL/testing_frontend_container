...
const downloadExcelFile = async (workbook, filename) => {
    ...
    const arrayToWorksheet = (array) => {
        ...
        const worksheet = workbook.addWorksheet('Tool Misssing Report');
    ...
    const handleDownload = () => {
        ...
        downloadExcelFile(workbook, 'Tool Missing Report .xlsx');
    };
...
export default ToolMissingReport;
