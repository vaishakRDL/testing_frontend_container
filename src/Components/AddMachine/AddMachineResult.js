...
import { ShowMachine, MachineDelete } from '../../ApiService/LoginPageService'
import DeleteConfirmationDailog from '../../Utility/confirmDeletion';
import '../../App.css';
import ApplicationStore from '../../Utility/localStorageUtil';
import { useModuleLocks } from '../context/ModuleLockContext';

const AddMachineResult = (props) => {
    ...
    const userPermission = userDetails?.groupRights?.filter((data) => data?.menu?.toLowerCase() === "machine");
    const moduleLocks = useModuleLocks();
    const isModuleLocked =
        moduleLocks.find(m => m.moduleName === "Machine")?.lockStatus === "locked";
                        ...
                        >
                            <DataGrid
                                ...
                                getRowClassName={(params) => {
                                    ...
                                    const rowIndex = machineList.findIndex(row => row.id === params.row.id);
...
export default AddMachineResult
