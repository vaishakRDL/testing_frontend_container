...
import InProcessReworkTitle from './InProcessReworkTitle';
import InProcessReworkPopup2 from './InProcessReworkPopup2';
import InProcessReworkApprovedPopup from './InProcessReworkapprovedPopup';
import InProcessReworkScrapPopup2 from './InProcessReworkScrapPopup2';
...
const InProcessReworkResult = ({ isSelectedData, setIsProcessInsp }) => {
    ...
    const [inProOpenReworkApprovedPopup, setInproOpenReworkApprovedPopup] = useState(false);
    const [inProOpenReworkScrapPopup, setInproOpenReworkScrapPopup] = useState(false);

    const [lpiInspectionList, setLpiInspectionList] = useState([]);
    ...
    useEffect(() => {
        Processinspection(
            { id: isSelectedData?.processId, jcNo: isSelectedData?.jcNo, type: "Rework",item: isSelectedData?.item },
            handleLPISucessShow,
            handleLPIExceptionShow
        );
        // GetItemVsProcessProcessList(handleItemVsProcessListSucessShow, handleItemVsProcessListExceptionShow);
    }, [refreshData]);


    const handleLPISucessShow = (dataObject) => {
        setLpiInspectionList(dataObject?.data || []);
    ...
    const handleCellEdit = (params) => {
        const updatedList = lpiInspectionList.map((supp) => {
    ...
    return (
        <div style={{ height: '60vh', width: '100%', padding: '10px' }}>
            <InProcessReworkTitle
                            ...
                            <CardContent>
                                ...
                                <DataGrid
                                    ...
                                    getRowClassName={(params) => {
                                        ...
                                        const rowIndex = lpiInspectionList.findIndex(row => row.id === params.row.id);
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} style={{ display: 'flex', flexDirection: 'row', justifyContent: "flex-end" }}>
                <Button {...buttonStyle1} style={{ marginRight: '20px' }}
                    onClick={() => {
                        setInproOpenReworkApprovedPopup(true);
                    }}
                >
                    Approved
                </Button>
                ...
                <Button {...buttonStyle1} style={{ marginRight: '20px' }}
                    onClick={() => {
                        setInproOpenReworkScrapPopup(true);
                    }}
                >
                    Scrap
                </Button>
            ...
            {/* <InProcessReworkPopup2
                setOpenReworkPopup2={setInproOpen}
                openReworkPopup2={inProOpen}
            /> */}

            <InProcessFPIreworkPopup
                setOpenFPIReworkPopup={setInproOpen}
                OpenFPIReworkPopup={inProOpen}
            ...
            <InProcessFPIApprovedPopup
                fpiInspectionList={fpiInspectionListUpdate}
                setOpenFPIApprovePopup={setInproOpenReworkApprovedPopup}
                OpenFPIApprovePopup={inProOpenReworkApprovedPopup}
                jobCardsNo={isSelectedData?.jcNo}
            />

            {/* <InProcessReworkApprovedPopup
                setOpenReworkApprovedPopup={setInproOpenReworkApprovedPopup}
                openReworkApprovedPopup={inProOpenReworkApprovedPopup}
            /> */}

            {/* <InProcessReworkScrapPopup2
                setOpenReworkScrapPopup={setInproOpenReworkScrapPopup}
                openReworkScrapPopup={inProOpenReworkScrapPopup}
            /> */}

            <InProcessFPIScrapPopup
                setOpenFPIScrapPopup={setInproOpenReworkScrapPopup}
                OpenFPIScrapPopup={inProOpenReworkScrapPopup}
                jobCardsNo={isSelectedData?.jcNo}
                fpiInspectionList={fpiInspectionListUpdate}
            />
...
export default InProcessReworkResult;