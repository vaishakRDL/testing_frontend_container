...
import '../../App.css';
import ProductMasterTitle from './ProductMasterTitle';
import ProductMasterModule from './ProductMasterModule';
...
const ProductMasterResult = () => {
    ...
    const userPermission = userDetails?.groupRights?.filter((data) => data?.menu?.toLowerCase() === "productmaster");
...
export default ProductMasterResult
