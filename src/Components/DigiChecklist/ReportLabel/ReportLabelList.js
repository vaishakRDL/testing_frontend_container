...
import ReportLabelTools from './ReportLabelTools';
import ReportLabelModel from './ReportLabelModel';

const ReportLabelList = () => {
      ...
      <Tooltip title="Edit">
        <EditIcon style={{ color: '#002D68', cursor: 'pointer' }}
          onClick={(event) => {
            ...
            setEditReport(props.selectedRow);
            setOpen(true);
          }}
        />
      </Tooltip>
...
export default ReportLabelList
