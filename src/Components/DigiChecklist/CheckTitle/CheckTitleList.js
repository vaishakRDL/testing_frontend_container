...
import CheckTitleTools from './CheckTitleTools';
import CheckTitleModel from './CheckTitleModel';

const CheckTitleList = () => {
      ...
      <Tooltip title="Edit">
        <EditIcon style={{ color: '#002D68', cursor: 'pointer' }}
          onClick={(event) => {
            ...
            setEditTitle(props.selectedRow);
            setOpen(true);
          }}
        />
      </Tooltip>
