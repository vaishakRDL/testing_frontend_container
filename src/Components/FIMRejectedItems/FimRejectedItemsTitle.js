...
import { GetFimRejectedItems } from '../../ApiService/LoginPageService';

const FimRejectedItemsTitle = (props) => {
//     const { setIsFpiReport,  setDrillFlag, drillFlag } = props;
...
// }
 const { setIsFpiReport, setDrillFlag, drillFlag, rejectedItems, setRejectedItems } = props;
    ...
    const handleReportView = () => {
        GetFimRejectedItems({ fromDate, toDate }, 
...
export default FimRejectedItemsTitle