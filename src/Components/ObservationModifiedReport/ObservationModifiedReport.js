...
import ObservationModifiedTitle from './ObservationModifiedTitle';
// import FPIReportTitle from './FPIReportTitle';
const label = { inputProps: { 'aria-label': 'Checkbox demo' } };

const ObservationModifiedReport = () => {
    ...
    const columns2 = [
        ...
        {
            field: 'LPI',
            headerName: <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Observation</span>,
            type: 'string',
            sortable: true,
            minWidth: 80,
            flex: 1,
...
export default ObservationModifiedReport;