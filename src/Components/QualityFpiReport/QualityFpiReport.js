...
const QualityFpiReport = ({ reportType }) => {
    ...
    const columns2 = [
        ...
        },
        {
            ...
            headerClassName: 'super-app-theme--header',
            headerName: (
                <span style={{ fontWeight: "bold", fontSize: "16px" }}>Reference No</span>
            ),
            type: "string",
            sortable: true,
            minWidth: 80,
        ...
        <div style={{ height: "100%", width: "100%" }}>
            {
                !isFpiReport ? (
                    <Grid container spacing={2} padding={2}>
                        ...
                        >
                            <Button disabled={loading}{...buttonStyle}>
                                {loading ? (
                        ...
                        <Grid
                            ...
                            onClick={onSubmit}
                        >
                            <Button disabled={submitloading}{...buttonStyle}>Submit</Button>
                        </Grid>
...
export default QualityFpiReport;
