            ...
            >
                <Grid container spacing={2} style={{ display: 'flex', flexWrap: 'nowrap' }}>
                    ...
                    <Grid item sm={12}>
                        ...
                        >
                            <Fab
                                style={{ width: '250px', background: userPermission[0]?.addData === 0 || isModuleLocked ? 'gray' : '#002D68', color: userPermission[0]?.addData === 0 ? 'black' : 'white' }}
                                disabled={userPermission[0]?.addData === 0 || isModuleLocked}
                                onClick={() => {
                                    props.setIsAddButton(true);
                                    props.setEditData([]);
...
export default ScrapModuleTitle
