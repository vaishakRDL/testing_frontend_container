import { Autocomplete, Button, Card, CircularProgress, CardContent, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, Grid, InputLabel, MenuItem, Select, TextField } from '@mui/material';
import { DataGrid } from '@mui/x-data-grid';
import React, { useEffect, useState } from 'react'
import { MachineShowData, OrderOList, SaleOrderFetch, ScrapMstGetCategory, ScrapMstGetMaterial, ScrapMstGetThickness, ScrapMstReport } from '../../ApiService/LoginPageService';
import ScrapReportModuleTitle from './ScrapReportModuleTitle';
import NotificationBar from '../GlobleFiles/ServiceNotificationBar';
import { ScrapReportCSV } from '../../ApiService/DownloadCsvReportsService';
import jsPDF from 'jspdf';
import 'jspdf-autotable';

const ScrapReportModule = ({
    itemDetaildView,
    setItemDetaildView,
    selectSalesId
}) => {
    ...
    const handleFileSave = () => {
        ...
        const headers = ['ID', 'Date', 'Category', 'Raw Material', 'Thickness', 'Machine Name', 'Weight Scan'];
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <FormControl style={{ width: '100%' }}>
                            <Autocomplete
                                ...
                                options={options3}
                                // sx={{ width: 300 }}
                                renderInput={(params) => <TextField {...params} label="Search By Thickness"
...
export default ScrapReportModule
