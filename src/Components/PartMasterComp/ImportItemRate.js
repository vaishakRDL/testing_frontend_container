...
import { DownloadItemRateTemplate, } from '../../ApiService/DownloadCsvReportsService';
import { ItemRateImport, ItemRateTemplate, ItemRateUpdate, } from '../../ApiService/LoginPageService';

const ImportItemRate = ({ open, setOpen }) => {
    ...
    const [itemLenght, setItemLenght] = useState(0);
    ...
    const handleItemStockImportSuccess = (dataObject) => {
        ...
        setItemLenght(dataObject?.data.length ?? 0);
        setNotification({
            status: true,
            type: 'success',
    ...
    const handleDownloadItemStockTemplateExlException = () => {
    ...
    const handleItemStockDataBaseException = () => {
                ...
                <Grid container spacing={2} style={{ marginTop: '10px', marginBottom: '20px' }}>
                    ...
                    <Grid item xs={12} sm={12} md={2} lg={3} xl={3} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <Button variant="contained"
                            onClick={() => {
                                DownloadItemRateTemplate(handleDownloadItemStockTemplateExlSuccess, handleDownloadItemStockTemplateExlException);
                            }}
                            sx={{
                                backgroundColor: '#002D68',
                                height: '40px',
