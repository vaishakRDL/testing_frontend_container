...
const InWardProcessFPITitle = (props) => {
    const { selectedOptionName, setIsChild, isChild, scrollToRow, selectedRowId } = props;
...
export default InWardProcessFPITitle;