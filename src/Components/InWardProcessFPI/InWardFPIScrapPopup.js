...
const InWardFPIScrapPopup = ({ setOpenFPIScrapPopup, OpenFPIScrapPopup, selectedOptionName, jobCardsNo, inspectionList, topData }) => {
...
export default InWardFPIScrapPopup;