...
import RejectionAndRework from './RejectionAndRework';
import ApplicationStore from '../../Utility/localStorageUtil';
import { useModuleLocks } from '../context/ModuleLockContext';

const RejectionAndReworkTitle = (props) => {
                        ...
                        >
                            <Fab
                                ...
                                onClick={() => {
                                    ...
                                    props.setEditRejectionAndRework([]);
                                    props.setOpen(true);
                                }}
...
export default RejectionAndReworkTitle