...
import { CancelSalesInvoiceSummary, CustomerDropShowdata, PartNoSelectShow } from "../../../ApiService/LoginPageService";
import NotificationBar from "../../GlobleFiles/ServiceNotificationBar";

const CancelSummarizedReport = () => {
                                    ...
                                    <tbody>
                                        {reportData && reportData.map((data, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>{data.gstNo}</td>
                                                <td>{data.hsnCode}</td>
                                                <td>{data.itemLedger}</td>
                                                <td>{data.uom}</td>
                                                <td>{data.totalQty}</td>
                                                <td>{data.taxableValueforGST}</td>
                                                <td>{data.lessDisc}</td>
                                                <td>{data.lessOther}</td>
                                                <td>{data.packingForw}</td>
                                                <td>{data.transportCharges}</td>
                                                <td>{data.custMeterialValue}</td>
                                                <td>{data.amtOfGstPay}</td>
                                                <td>{data.CGSTPer}</td>
                                                <td>{data.CGST}</td>
                                                <td>{data.SGSTPer}</td>
                                                <td>{data.SGST}</td>
...
export default CancelSummarizedReport;