...
import { DownloadCustVsItemPriceTemplate } from '../../../ApiService/DownloadCsvReportsService';
import ImportXlMissingItems from './ImportXlMissingItems';
import CustomerVsItemMissing from './CustomerVsItemMissing';
import { CustVsItemXLImportXl } from '../../../ApiService/LoginPageService';

const ImportXlCustItem = ({ excelModal, setExcelModal, customerSelect }) => {
    ...
    const handleFileChange = (event) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                CustVsItemXLImportXl({ customerId: customerSelect, file: base64String }, handleXLImportXlSucessShow, handleXLImportXlExceptionShow)
            };
    ...
    const handleDownloadTemplate = () => {
        DownloadCustVsItemPriceTemplate(handleTemplateDownloadSucessShow, handleTemplateDownloadExceptionShow)
    };
...
export default ImportXlCustItem;
