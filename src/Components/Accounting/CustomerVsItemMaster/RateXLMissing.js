...
const RateXLMissing = ({ handleLoadButtonClick, missingLists, setMissingModal, missingModal, type }) => {
    ...
    const xlColumns = [
        ...
        },
        {
            field: 'reason',
            headerClassName: 'super-app-theme--header',
            headerName: <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Error Reasons</span>,
            type: 'string',
            sortable: true,
            minWidth: 100,
            flex: 1,
