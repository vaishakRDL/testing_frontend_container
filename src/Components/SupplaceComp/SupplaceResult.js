...
import SupplaceTitle from './SupplaceTitle';
import SupplaceModule from './SupplaceModule';
import '../../App.css';
import ApplicationStore from '../../Utility/localStorageUtil';
import { useModuleLocks } from '../context/ModuleLockContext';

const SupplaceResult = () => {
    ...
    const userPermission = userDetails?.groupRights?.filter((data) => data?.menu?.toLowerCase() === "addsupplyplace");

    const moduleLocks = useModuleLocks();
    const isModuleLocked =
        moduleLocks.find(m => m.moduleName === "Supply")?.lockStatus === "locked";
    const columns = [
        {
            field: 'customerName',
