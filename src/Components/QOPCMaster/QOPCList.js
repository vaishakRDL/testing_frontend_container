...
import { COPQDelete, COPQShowData, QualityInsMstDelete } from '../../ApiService/LoginPageService';
import ApplicationStore from '../../Utility/localStorageUtil';
import QOPCTitle from './QOPCTitle';
import QOPCModel from './QOPCModel';
...
const QOPCList = () => {
  ...
  useEffect(() => {
    COPQShowData(handleQualityInsMstShow, handeQualityInsMstException);
  }, [refreshData]);
