...
import MaterialIssueNoteTitle from './MaterialIssueNoteTitle';

const MaterialIssueNote = ({
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm={12} md={3} lg={3} xl={3}>
                                        ...
                                        /> */}
                                        <FormControl fullWidth>
                                            <InputLabel id="demo-simple-select-label">MN No</InputLabel>
                                            <Select
                                                labelId="demo-simple-select-label"
                                                id="demo-simple-select"
                                                // value={age}
                                    ...
                                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                                        <Button variant="contained">Load Pending SRN</Button>
                                    </Grid>
                                </Grid>
                            </Grid>
                        </Grid>
                                    ...
                                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                                        <Card style={{ boxShadow: '0 10px 10px 10px rgba(0, 0, 0, 0.2)', borderRadius: '10px', width: '100%', height: '100%' }}>
                                            <CardContent>
                                                <DataGrid
                                                    rows={[]}
                                                    columns={bottomRightGridColumns}
                                                    pageSize={8}
                                                    // loading={isLoading}
                                                    rowsPerPageOptions={[8]}
                                                    disableSelectionOnClick
