...
import LPIModifiedTitle from './LPIMlodifiedTitle';
// import FPIReportTitle from './FPIReportTitle';
const label = { inputProps: { 'aria-label': 'Checkbox demo' } };

const LPIModifiedReport = () => {
    ...
    const columns2 = [
        ...
        {
            field: 'LPI',
            headerName: <span style={{ fontWeight: 'bold', fontSize: '16px' }}>LPI</span>,
            type: 'string',
            sortable: true,
            minWidth: 80,
            flex: 1,
...
export default LPIModifiedReport;