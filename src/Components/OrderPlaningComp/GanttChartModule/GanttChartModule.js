...
import { Button, ButtonGroup, FormControl, Grid, CircularProgress, InputLabel, MenuItem, Select, TextField, Typography } from "@mui/material";
      ...
      <Grid container spacing={2} style={{ backgroundColor: '#ffffff', paddingLeft: '20px' }}>
        ...
        <Grid item xs={12} sm={12} md={1} lg={1} xl={1} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }} >
          <Button
            ...
            disabled={!selectedFromDate || !selectedToDate || submitloading} // only ONE disabled prop
          >
            {submitloading ? (
