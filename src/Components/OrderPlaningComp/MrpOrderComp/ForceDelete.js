...
const ForceDelete = ({ open, setOpen, selectRowId, setRefreshData }) => {
    ...
    return (
        ...
        >
            <DialogTitle sx={{ textAlign: 'center' }}>
                <DeleteForeverIcon color="red" style={{ fontSize: 95, color: 'red' }} />
            </DialogTitle>
            ...
            <DialogContent sx={{
                ...
                <Typography sx={{
                    ...
                    Are you sure you want to Delete this Forcefully?
