...
import RejectedItemsTitle from './RejectedItemsTitle';
import { ViewSfgVendorProcess, DeleteCreatedGroup, SearchVendorProcessVendor, GetRejectedItems } from '../../ApiService/LoginPageService'
...
const RejectedItemsResult = (props) => {
    ...
    const columns = [
        ...
        },
        {
            field: 'Shift',
            headerClassName: 'super-app-theme--header',
            headerName: <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Shift</span>,
            type: 'string',
            sortable: true,
            minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
        },
        ...
        },
        {
            field: 'rejRewQty',
            headerClassName: 'super-app-theme--header',
            headerName: <span style={{ fontWeight: 'bold', fontSize: '16px' }}>RejectedRewQty</span>,
            type: 'number',
            sortable: true,
            sortable: false,
            minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
        },
        {
            field: 'Operator_Name',
            headerClassName: 'super-app-theme--header',
            headerName: <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Operator Name</span>,
            type: 'number',
            sortable: true,
            sortable: false,
            minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
    ...
    const handleViewClick = () => {
        setViewButton(true);
        GetRejectedItems({ from: from, to: to }, handleRejectedItemsSucess, handleRejectedItemsException)
    }
                        ...
                        <CardContent>
                            <Grid container spacing={2} alignItems={'center'} paddingBottom={1} >
                                ...
                                <Grid item xs={12} sm={4} md={4} lg={4} style={{ columnGap: '12px', display: 'flex' }} >
                                    ...
                                    <Button variant="contained" style={{ backgroundColor: isModuleLocked ? 'gray' : '#002d68' }} disabled={isModuleLocked} onClick={handleSubmitClick}>
                                        Submit
                                    </Button>
...
export default RejectedItemsResult