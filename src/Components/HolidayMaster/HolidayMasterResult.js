...
import HolidayMasterModule from './HolidayMasterModule';
import HolidayMasterTitle from './HolidayMasterTitle';
import { DeleteHoliday, ShowHoliday } from '../../ApiService/LoginPageService';
import '../../App.css';
import ApplicationStore from '../../Utility/localStorageUtil';
import { useModuleLocks } from '../context/ModuleLockContext';

const HolidayMasterResult = () => {
    ...
    const isModuleLocked =
        moduleLocks.find(m => m.moduleName === "Holiday Master")?.lockStatus === "locked";
    ...
    useEffect(() => {
        ShowHoliday(handleSobShowDataSuccess, handleSobShowDataException);
    }, [refreshData]);
...
export default HolidayMasterResult
