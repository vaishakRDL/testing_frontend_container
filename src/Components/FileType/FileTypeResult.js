...
import { DeleteHoliday, NpdFileTypeDataDelete, NpdFileTypeShow, ShowHoliday } from '../../ApiService/LoginPageService';
import FileTypeModule from './FileTypeModule';
import FileTypeMasterTitle from './FileTypeMasterTitle';
import '../../App.css';
...
const FileTypeResult = () => {
    ...
    const userPermission = userDetails?.groupRights?.filter((data) => data?.menu?.toLowerCase() === "filetypemaster");

    const moduleLocks = useModuleLocks();
    const isModuleLocked =
        moduleLocks.find(m => m.moduleName === "File Master")?.lockStatus === "locked";
    ...
    return (
        <div style={{ height: '80vh', margin: '20px' }}>
            ...
            <DeleteConfirmationDailog
                ...
                deleteId={deleteId}
                deleteService={NpdFileTypeDataDelete}
