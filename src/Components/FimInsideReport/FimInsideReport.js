...
import { GetItemVsProcessItem, GetItemVsProcessProcessList, AddItemVsProcess, ProcessInspecReportViewId, AssemblyInspecReportInsideData, FimInspecReportInsideData } from '../../ApiService/LoginPageService';
import { useNavigate } from 'react-router-dom';
import { QualityAssemblyReportXl, QualityFpiReportXl, QualityReport } from '../../ApiService/DownloadCsvReportsService';
import QualityAssemblyReport from '../QualityAssemblyReport/QualityAssemblyReport';
import FimInsideTitle from './FimInsideTitle';
// import FPIReportTitle from './FPIReportTitle';
const label = { inputProps: { 'aria-label': 'Checkbox demo' } };

const FimInsideReport = ({ setIsFpiReport, id, reportType }) => {
...
export default FimInsideReport;