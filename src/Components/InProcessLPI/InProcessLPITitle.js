    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', flexDirection: 'row', cursor: 'pointer' }}>
                {/* <Link to='/ProcessInspectionResult' style={{ textDecoration: 'none' }}> */}
                <Typography
                    sx={{ m: 1, fontFamily: 'Roboto Slab', fontWeight: 'bold', color: '#0769d9', '&:hover': { color: '#043f82' } }}
                    variant="h5"
                    onClick={() => props.setIsProcessInsp(0)}
                >
                    {`Process Inspection>>`}
                </Typography>
                {/* </Link> */}
...
export default InProcessLPITitle;