...
import InProcessLPITitle from './InProcessLPITitle';
import InProcessLPIReworkPopup from './InProcessLPIReworkPopup';
import InProcessLPIApprovedPopup from './InProcessLPIApprovedPopup';
import InProcessLPIScrapPopup from './InProcessLPIScrapPopup';
...
const InProcessLPIResult = ({ isSelectedData, setIsProcessInsp }) => {
    ...
    const [OpenLPIApprovePopup, setOpenLPIApprovePopup] = useState(false);
    const [OpenLPIReworkPopup, setOpenLPIReworkPopup] = useState(false);
    const [OpenLPIScrapPopup, setOpenLPIScrapPopup] = useState(false);
    ...
    useEffect(() => {
        Processinspection(
            { id: isSelectedData?.processId, jcNo: isSelectedData?.jcNo, type: "LPI",item:isSelectedData?.item },
            handleLpiSucessShow,
    ...
    return (
        <div style={{ height: '60vh', width: '100%' }}>
            ...
            {/* <InProcessLPIApprovedPopup
                setOpenLPIApprovePopup={setOpenLPIApprovePopup}
                OpenLPIApprovePopup={OpenLPIApprovePopup}
            /> */}

            <InProcessFPIApprovedPopup
                fpiInspectionList={fpiInspectionListUpdate}
                setOpenFPIApprovePopup={setOpenLPIApprovePopup}
                OpenFPIApprovePopup={OpenLPIApprovePopup}
                jobCardsNo={isSelectedData?.jcNo}
            />

            {/* <InProcessLPIReworkPopup
                setOpenLPIReworkPopup={setOpenLPIReworkPopup}
                OpenLPIReworkPopup={OpenLPIReworkPopup}
            /> */}

            <InProcessFPIreworkPopup
                setOpenFPIReworkPopup={setOpenLPIReworkPopup}
                OpenFPIReworkPopup={OpenLPIReworkPopup}
                jobCardsNo={isSelectedData?.jcNo}
                fpiInspectionList={fpiInspectionListUpdate}
            />

            {/* <InProcessLPIScrapPopup
                setOpenLPIScrapPopup={setOpenLPIScrapPopup}
                OpenLPIScrapPopup={OpenLPIScrapPopup}
            /> */}

            <InProcessFPIScrapPopup
                setOpenFPIScrapPopup={setOpenLPIScrapPopup}
                OpenFPIScrapPopup={OpenLPIScrapPopup}
                jobCardsNo={isSelectedData?.jcNo}
                fpiInspectionList={fpiInspectionListUpdate}
            />
        </div>
...
export default InProcessLPIResult;