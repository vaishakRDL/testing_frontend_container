...
import { getGstAllSaleInvoiceList, getGstSaleInvoiceData, getGstSaleInvoiceList, getGstSaleInvoicePayload, getPurchasebillagainstInvList, getPurchasebillagainstList, getPurchaseSelectionList, GSTSalesShowData, MultiXmlPrint, StoreGstSaleInvoiceResponse, updatePrintedInvoiceStatus } from '../../../ApiService/LoginPageService';
...
const PurchaseBillMultiPrint = () => {
    ...
    const handleRowSelection = (selectionModel) => {
        ...
        getPurchaseSelectionList({ invoiceIds: selectionModel }, handleGetPayloadSuccess, handleGetPayloadException)
    };
    ...
    return (
        <Box sx={{ height: 400, width: '100%', padding: '20px' }}>
            <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: '20px' }}>
                <Link to='/PurchaseBillAgaintPOModule' style={{ textDecoration: 'none' }}>
                    <Typography
                ...
                <Typography style={{ textAlign: 'left', fontSize: '18px', fontWeight: 'bold' }}>Multi Print</Typography>
            </div>
...
export default PurchaseBillMultiPrint
