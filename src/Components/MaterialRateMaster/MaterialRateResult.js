...
import { COPQDelete, COPQShowData, MaterialRateDelete, MaterialRateShowData, QualityInsMstDelete } from '../../ApiService/LoginPageService';
import ApplicationStore from '../../Utility/localStorageUtil';
import MaterialRateTitle from './materialRateTitle';
import MaterialRateModel from './MaterialModel';
import { useModuleLocks } from '../context/ModuleLockContext';

const MaterialRateResult = () => {
    ...
    const [editMaterialQuality, setEditMaterialQuality] = useState([]);
    ...
    useEffect(() => {
        MaterialRateShowData(handleQualityInsMstShow, handeQualityInsMstException);
    }, [refreshData]);
                ...
                <EditIcon
                    ...
                    onClick={(event) => {
                        if (userPermission[0]?.updateData === 1 && !isModuleLocked) {
                            ...
                            setEditMaterialQuality(props.selectedRow);
                            setOpen(true);
                        }
                    }}
                />
    ...
    return (
        <div style={{ height: '60vh', width: '100%' }}>
            <MaterialRateTitle
                ...
                setEditMaterialQuality={setEditMaterialQuality}
                setOpen={setOpen}
            />
            ...
            <MaterialRateModel
                ...
                editMaterialQuality={editMaterialQuality}
                open={open}
                setOpen={setOpen}
            ...
            <DeleteConfirmationDailog
                ...
                deleteId={deleteId}
                deleteService={MaterialRateDelete}
...
export default MaterialRateResult
