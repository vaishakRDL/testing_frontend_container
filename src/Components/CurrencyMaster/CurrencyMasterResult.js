...
import CurrencyMasterTitle from './CurrencyMasterTitle';
import CurrencyMaster from './CurrencyMaster';

const CurrencyMasterResult = () => {
    ...
    const columns = [
        ...
        {
            field: 'Currencyseries',
            headerName: 'Currency Series',
            type: 'string',
            sortable: true,
            minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
        },
        {
            field: 'Currencyno',
            headerName: 'Currency No',
            type: 'string',
            sortable: true,
            minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
        },
        {
            field: 'Currencyroadclean',
            headerName: 'Currency Road Clean',
            type: 'string',
            sortable: true,
            minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
        },
...
export default CurrencyMasterResult