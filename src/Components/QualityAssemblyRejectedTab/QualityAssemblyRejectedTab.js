...
import AssemblyRejectedItemsResult from '../AssemblyRejectedItems/AssemblyRejectedItemsResult';
import FimRejectedItemsResult from '../FIMRejectedItems/FimRejectedItemsResult';
...
export default function QualityAssemblyRejectedTab() {
        ...
        <Box sx={{ width: '100%', typography: 'body1' }}>
            <TabContext value={value}>
                ...
                <TabPanel value="1" style={{ padding: 0 }}>
                    <AssemblyRejectedItemsResult />
                </TabPanel>
                <TabPanel value="2" style={{ padding: 0 }}>
                    <FimRejectedItemsResult />
                </TabPanel>
            </TabContext>
        </Box>
    );
