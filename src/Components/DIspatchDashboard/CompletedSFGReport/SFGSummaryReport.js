...
const SFGSummaryReport = () => {
  ...
  const handleDownload = () => {
    // Map reportData to match columns exactly
    const formattedData = reportData.map((supp, index) => ({
      "SI No": supp.sNo || index + 1,
      "Item Code": supp.itemCode,
      "Item Name": supp.itemName,
      "Total Inward Qty": supp.totalInwardQty,
      "Total Outward Qty": supp.totalOutwardQty,
      "Total Stock": supp.totalStock,
    }));
  ...
  const columns = [
    ...
    {
      field: 'totalInwardQty',
      headerClassName: 'super-app-theme--header',
      headerName: (
        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Total Inward Qty</span>
      ),
      type: 'string',
      sortable: true,
      minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
    ...
    {
      field: 'totalOutwardQty',
      headerClassName: 'super-app-theme--header',
      headerName: (
        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Total Outward Qty</span>
      ),
      type: 'string',
      sortable: true,
    ...
    },
    {
      ...
      headerClassName: 'super-app-theme--header',
      headerName: (
        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Total Stock</span>
      ),
      type: 'string',
      sortable: true,
      minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
...
export default SFGSummaryReport;
