...
// import { ScrapMstGetMaterial } from "../../../ApiService/LoginPageService";
...
const CompletedSFG = () => {
  ...
  const arrayToWorksheet = (array) => {
    ...
    const worksheet = workbook.addWorksheet('Completed SFG Stock Report');
...
const handleDownload = () => {
    ...
    downloadExcelFile(workbook, 'Completed SFG Stock Report.xlsx');
};
  ...
  const columns = [
    ...
    // },
    {
      ...
      headerClassName: 'super-app-theme--header',
      headerName: (
        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Qc Approval</span>
      ),
      type: 'string',
      sortable: true,
      minWidth: 100, flex: 1, align: 'center', headerAlign: 'center'
