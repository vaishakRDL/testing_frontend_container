...
import { PartVsInspectionCopyFromXLUpload } from '../../ApiService/LoginPageService';
import MissingModal from '../ItemVsProcess/MissingModal/MissingModal';
import { GetItemVsProcessCopyTemplate, GetPartProcessCopyTemplate } from '../../ApiService/DownloadCsvReportsService';

const CopyForm = ({ copyFromModal, setCopyFromModal, type }) => {
    ...
    const handleDownloadTemplate = () => {
        if(type==='itemProcess'){
            ...
            GetPartProcessCopyTemplate(handleTemplateDownloadSucessShow, handleTemplateDownloadExceptionShow)
        }
    };
    ...
    const handleFileUpload = () => {
        setIsLoader(true);
        PartVsInspectionCopyFromXLUpload({ file: excelBase64File }, handleCopyFromUploadSucessShow, handleCopyFromUploadExceptionShow)
    }
